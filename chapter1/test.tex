...
\begin{enumerate}
    ...
    \item   
     \begin{eqnarray*}
              ...
              &\beta - \alpha = \delta \approx (n-1)\alpha
          \end{eqnarray*}
    \item 
    光纤内需全反射，
          \begin{eqnarray*}
              & n_0\sin(I_1) = n_1 \sin(I_2) \\
              &  n_1 \sin(\frac{\pi}{2}-I_2) = n_2 \\
              & n_0\sin(I_1) = \sqrt{n_1^2 - n_2^2}
          \end{eqnarray*}
    \item \begin{eqnarray*}
    ...
    \begin{eqnarray*}
        & \beta = -4,l = \frac{5}{8r},l^{\prime} = \frac{5}{2r}\\
        & \beta = 4,l = \frac{3}{8r},l^{\prime} = -\frac{3}{2r}\\
